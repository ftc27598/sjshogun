  ...
  return <section id="who-we-are" className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="space-y-6 text-lg md:text-xl text-muted-foreground leading-relaxed">
          <p>Saint John's Shogun is a competitive First Technical Challenge robotics team driven by innovation, collaboration, and a passion for STEM excellence. We are engineers, designers, programmers, and problem-solvers united by a common goal: pushing the boundaries of what's possible.</p>
          <p>
